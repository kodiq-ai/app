  ...
  return (
    <div className="flex flex-1 items-center justify-center">
      <div className="flex w-full max-w-[320px] flex-col items-center gap-10 px-6">
        ...
        <div className="anim-2 flex w-full flex-col gap-2">
          ...
          >
            ...
            <div className="flex-1 text-left">
              <div className="text-[13px] font-medium text-[#E6E6E9]">{t("openProject")}</div>
              <div className="mt-0.5 text-[11px] text-[#6E6E76]">{t("selectFolder")}</div>
            </div>
          ...
          >
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-white/[0.03] text-[#A1A1A8]">
              <Plus className="size-4" />
            </div>
            <div className="flex-1 text-left">
              <div className="text-[13px] font-medium text-[#E6E6E9]">{t("newProject")}</div>
              <div className="mt-0.5 text-[11px] text-[#6E6E76]">{t("createFromScratch")}</div>
            </div>
            <span className="text-[9px] font-medium tracking-wider text-[#6E6E76] uppercase">
              {t("comingSoon")}
            </span>
          </Button>
        </div>
            ...
            <div className="flex flex-col gap-px">
              {recentProjects.map((p) => (
                ...
                >
                  ...
                  <span className="flex-1 truncate text-left text-[12px] text-[#A1A1A8] transition-colors group-hover:text-[#A1A1A8]">
                    {p.name}
                  </span>
          ...
          <div className="flex flex-col gap-px">
            {installedCli.map((tool) => (
              <div key={tool.name} className="flex items-center gap-2.5 rounded-lg px-3 py-2">
                ...
                <span className="flex-1 text-[12px] text-[#A1A1A8]">{tool.name}</span>
            ...
            {cliTools.length === 0 && (
              <div className="flex items-center gap-2.5 px-3 py-2 text-[11px] text-[#6E6E76]">
                {t("searchingTools")}
              </div>
            )}
          </div>
        ...
        {/* Version */}
        <div className="anim-5 text-[10px] text-[#202024]">v0.1.0</div>
      </div>
    </div>
  );
}
