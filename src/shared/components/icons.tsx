...
export function KodiqIcon({ size = 56 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 1024 1024" fill="none">
      <rect width="1024" height="1024" rx="228" fill="#1A1A1D" />
      {/* K symbol */}
      <path
        d="M189 174H361.727V377.818L580.515 174H735.969L520.636 376.667L835 676.06H619.666L361.727 431.939V540.182H189V174Z"
        fill="#E6E6E9"
      />
      <path d="M189 676.062V564.365H461.909L580.515 676.062H189Z" fill="#E6E6E9" />
      <path d="M389.364 314.485L389.364 174L540.104 174L389.364 314.485Z" fill="#E6E6E9" />
      {/* KODIQ wordmark */}
      <path
      ...
      <path
        ...
        fill="#E6E6E9"
      />
      <rect x="633.203" y="741.461" width="24.6096" height="105.821" fill="#E6E6E9" />
    </svg>
  );
}
...
export function FileIcon({ name, isDir }: { name: string; isDir: boolean }) {
  if (isDir) return <Folder className="size-3 fill-[#6E6E76] text-[#6E6E76]" />;
  ...
  return <FileText className="size-3" style={{ color: colors[ext] || "#6E6E76" }} />;
}
